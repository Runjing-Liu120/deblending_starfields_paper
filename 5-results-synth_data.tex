...
\begin{figure}[!htb]
    ...
    On the left, a randomly initialized run where optimizing the ELBO with the reparameterized gradient resulted in a shallow local optimum: 
    a star was missed by the modal catalog. 
