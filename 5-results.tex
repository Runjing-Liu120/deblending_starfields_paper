...
\jeff{Just the model is enough. Nvidia GeForce RTX 2080 Ti, if we're taking about deeplearning-01.}
...
this more precise.}
\jeff{You could we ``we project'' or ``we expect'' rather ``would require'', to account for the uncertainty. It's probably not that far off though.}
