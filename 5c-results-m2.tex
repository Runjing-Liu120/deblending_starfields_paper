...
by tiling the image into $R \times R$ tiles. On the crowded starfield described below, we used $R = 2$. 
...
We tested Starnet (TODO: to avoid saying ``our method" so much in this section, I gave our method a name. If this name works, I'll introduce it in earlier sections) on the SDSS image of M2, a crowded starfield found in run 2583, camcol 2, and field 136.
...
We compared Starnet with PCAT and DAOPHOT. The DAOPHOT catalog of M2 was reported in 
...
\bryan{Oh -- so I should say, that certainly two bands is better than one band. It's just three (or more) bands didn't improve much more than two bands. Is that better?}
...
than PCAT. This is in agreement with the discussion of Section~\ref{sec:kl_q_p}. 
\newpage
