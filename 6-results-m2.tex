...
We consider the $100 \times 100$ pixel subimage of M2 that \cite{Portillo_2017} and \cite{Feder_2019} analyzed with PCAT.
...
\begin{figure}[tb]
    ...
    For PCAT, the magnitude histogram plotted is from a single catalog sampled by MCMC. 
