...
which has greater resolution than the Sloan telescope (0.05 and 0.4 arcseconds per pixel, respectively; see~\cite{hubble_about} and~\cite{sdss_about}). The catalog from this Hubble survey (henceforth the ``HST catalog") serves as ground truth for validating our results.
