...
\jeff{I suggest deleting the paragraph above. It doesn't seem to have anything to do with VI, which is the title of this section.}
...
\jeff{Better to use lowercase $p_\theta$ here for symmetry with $q_\eta$.}
...
\begin{figure}[h]
    ...
    \label{fig:ex_tiles}
\end{figure}
\jeff{In the figure caption: Patches? Or tiles? Pick one term and use it consistently. I think tiles is a bit more clear.}
