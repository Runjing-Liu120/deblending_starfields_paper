...
\begin{figure}[!ht]
    ...
    \caption{An example image with four tiles. The upper-left tile has two stars; the upper-right and lower-left has one; the bottom right has none. 
    On each tile, we index into the triangular array. 
