...
In particular, optimizing the forward KL involves sampling {\itshape complete} data---images and their corresponding catalogs---from their joint likelihood and fitting the network in a supervised fashion.
