...
advances astronomical research in which conclusions about the physical universe are derived from estimated catalogs.

We focus on cataloging applications in which all light sources are well modeled as points without spatial extent.
Point-source-only models are applicable to surveys such as Dark Energy Camera (DECam) plane survey,
...
StarNet was also more accurate that traditional deterministic cataloging approaches.
