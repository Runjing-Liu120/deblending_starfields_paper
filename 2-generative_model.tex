...
\jeff{Which band is the first? Do you want to designate one band the ``reference band'' ? That's what we did in the Celeste journal article.
Alternative, you could make $f$ the total flux across all bands, but that may be more cumbersome.
}
...
\jeff{Better to introduce this notation where you first mention triangular arrays, instead of here.}
