...
An astronomical image records the number of these photons that have traveled through a telescope and arrived at each pixel. Typically, photons must pass through one of several filters, each absorbing energy within a specified band of wavelengths, before being recorded.
