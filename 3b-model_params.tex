...
\end{align} 
To estimate model parameters, the goal is to optimize $\log \Prob_\phi(X)$; however, 
since the marginal log-likelihood is intractable, we optimize a lower bound as a surrogate for the marginal log-likelihood. 
